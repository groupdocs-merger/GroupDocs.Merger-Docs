---
id: merge-odt
url: merger/net/merge/odt
title: Merge ODT
description: "Learn how to merge ODT files, combine ODT files into one file programmatically in C# language using GroupDocs.Merger for .NET library."
keywords: Merge ODT files in C#, Combine ODT files programmatically
...
[!["Merge ODT"](merger/net/images/merge/merge-odt.png)](https://products.groupdocs.app/merger/odt)