...
url: merger/python-net/getting-started/system-requirements
title: System Requirements
linkTitle: System Requirements
weight: 3
description: "System requirements for GroupDocs.Merger for Python via .NET — supported operating systems, Python versions, and optional platform dependencies."
keywords: GroupDocs.Merger for Python via .NET, system requirements, Windows, Linux, macOS, Python 3.5, Python 3.14, libgdiplus, libSkiaSharp
productName: GroupDocs.Merger for Python via .NET
hideChildren: false
toc: true
aliases:
    - /merger/python-net/system-requirements/
---

{{< alert style="info" >}}
GroupDocs.Merger for Python via .NET ships as a self-contained wheel that bundles the .NET runtime it needs. No Microsoft Office, Adobe Acrobat, or Mono install is required.
{{< /alert >}}
...
GroupDocs.Merger for Python via .NET supports every Python release from **3.5** through **3.14**.
...
The library is distributed on [PyPI](https://pypi.org/project/groupdocs-merger-net/) under the name **`groupdocs-merger-net`** and ships as four platform-specific wheels per release:
...
GroupDocs.Merger uses `System.Drawing.Common` for image rendering (image joins and page previews), which on Linux needs a few system packages. Install them with `apt`, `dnf`, or the equivalent for your distribution:
