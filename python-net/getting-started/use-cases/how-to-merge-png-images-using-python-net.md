...
with Merger("./sample1.png") as merger:
    image_join_options = ImageJoinOptions(FileType.PNG, ImageJoinMode.VERTICAL)
    merger.join("./sample2.png", image_join_options)
    merger.join("./sample3.png", image_join_options)
